...
2. **`app/api/webhook.py`**: Endpoint receptor para la API de WhatsApp. Controla la firma de seguridad HMAC, extrae mensajes, maneja respuestas interactivas, y despacha la lógica del bot.
